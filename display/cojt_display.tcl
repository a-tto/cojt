...
CONFIG.NUM_MI {3} \
  ...
  set regbus_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:regbus_v2_0:1.0 regbus_0 ]
...
CONFIG.CONST_WIDTH {6} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI] [get_bd_intf_pins regbus_0/s00_axi]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins display_0/RESOL] [get_bd_pins dispsub_0/RESOL]
  ...
  connect_bd_net -net display_0_DSP_IRQ [get_bd_pins display_0/DSP_IRQ] [get_bd_pins processing_system7_0/IRQ_F2P]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins display_0/ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins regbus_0/s00_axi_aclk] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins dispsub_0/CLK40] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net regbus_0_BYTEEN [get_bd_pins display_0/BYTEEN] [get_bd_pins regbus_0/BYTEEN]
  connect_bd_net -net regbus_0_RDADDR [get_bd_pins display_0/RDADDR] [get_bd_pins regbus_0/RDADDR]
  connect_bd_net -net regbus_0_RDEN [get_bd_pins display_0/RDEN] [get_bd_pins regbus_0/RDEN]
  connect_bd_net -net regbus_0_WDATA [get_bd_pins display_0/WDATA] [get_bd_pins regbus_0/WDATA]
  connect_bd_net -net regbus_0_WRADDR [get_bd_pins display_0/WRADDR] [get_bd_pins regbus_0/WRADDR]
  connect_bd_net -net regbus_0_WREN [get_bd_pins display_0/WREN] [get_bd_pins regbus_0/WREN]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins display_0/ARESETN] [get_bd_pins dispsub_0/ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins regbus_0/s00_axi_aresetn] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins regbus_0/RDATA_CAPT] [get_bd_pins regbus_0/RDATA_DRAW] [get_bd_pins regbus_0/RDATA_OPT0] [get_bd_pins regbus_0/RDATA_OPT1] [get_bd_pins regbus_0/RDATA_OPT2] [get_bd_pins regbus_0/RDATA_OPT3] [get_bd_pins regbus_0/RDATA_SOUND] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces display_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs regbus_0/s00_axi/reg0] SEG_regbus_0_reg0
...
preplace port DVI_DE -pg 1 -y 530 -defaultsOSRD
preplace port DVI_CLK -pg 1 -y 470 -defaultsOSRD
preplace port DVI_VSYNC -pg 1 -y 510 -defaultsOSRD
preplace port DVI_HSYNC -pg 1 -y 490 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 900 -defaultsOSRD
preplace port DVI_RST -pg 1 -y 950 -defaultsOSRD
preplace port DVI -pg 1 -y 800 -defaultsOSRD
preplace portBus DVI_DATA -pg 1 -y 550 -defaultsOSRD
preplace portBus LED -pg 1 -y 1050 -defaultsOSRD
preplace inst axi_iic_0 -pg 1 -lvl 6 -y 820 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 4 -y 120 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 5 -y 1090 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 6 -y 1050 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 6 -y 700 -defaultsOSRD
preplace inst rst_processing_system7_0_50M -pg 1 -lvl 1 -y 760 -defaultsOSRD
preplace inst util_reduced_logic_0 -pg 1 -lvl 6 -y 950 -defaultsOSRD
preplace inst display_0 -pg 1 -lvl 2 -y 530 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -y 660 -defaultsOSRD
preplace inst regbus_0 -pg 1 -lvl 6 -y 160 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 5 -y 700 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 4 -y 680 -defaultsOSRD
preplace inst dispsub_0 -pg 1 -lvl 6 -y 500 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 4 3 1420J 890 NJ 890 2090J
preplace netloc xlconstant_1_dout 1 5 1 1770J
preplace netloc display_0_DSP_DE 1 2 4 N 530 NJ 530 NJ 530 1740J
preplace netloc regbus_0_WREN 1 1 6 390 350 NJ 350 NJ 350 NJ 350 NJ 350 2100
preplace netloc regbus_0_WRADDR 1 1 6 400 340 NJ 340 NJ 340 NJ 340 NJ 340 2110
preplace netloc dispsub_0_DVI_HSYNC 1 6 1 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 5 1 N
preplace netloc rst_processing_system7_0_50M_interconnect_aresetn 1 1 4 N 780 720 780 1000J 830 1460J
preplace netloc regbus_0_RDEN 1 1 6 370 330 NJ 330 NJ 330 NJ 330 NJ 330 2070
preplace netloc display_0_DSP_FIFO_OVER 1 2 4 670 1040 NJ 1040 NJ 1040 1760J
preplace netloc processing_system7_0_M_AXI_GP0 1 4 1 1440
preplace netloc dispsub_0_DVI_DE 1 6 1 NJ
preplace netloc display_0_DSP_IRQ 1 2 2 N 450 990J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 5 20 670 320J 820 NJ 820 NJ 820 1400
preplace netloc dispsub_0_DVI_DATA 1 6 1 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 N
preplace netloc display_0_DSP_B 1 2 4 N 510 NJ 510 NJ 510 1760J
preplace netloc rst_processing_system7_0_50M_peripheral_aresetn 1 1 5 330 260 710 260 NJ 260 1450 260 1770
preplace netloc dispsub_0_DVI_VSYNC 1 6 1 NJ
preplace netloc dispsub_0_DVI_CLK 1 6 1 NJ
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 5 1 1750
preplace netloc regbus_0_RDADDR 1 1 6 360 320 NJ 320 NJ 320 NJ 320 NJ 320 2080
preplace netloc xlconstant_0_dout 1 4 2 NJ 120 1790
preplace netloc xlconcat_0_dout 1 6 1 NJ
preplace netloc display_0_RDATA 1 2 4 690J 70 NJ 70 NJ 70 1790
preplace netloc display_0_DSP_FIFO_UNDER 1 2 4 660 1030 NJ 1030 NJ 1030 NJ
preplace netloc axi_gpio_0_gpio_io_o 1 1 6 420 370 NJ 370 NJ 370 NJ 370 1800 370 2080
preplace netloc processing_system7_0_FIXED_IO 1 4 3 1410J 900 NJ 900 NJ
preplace netloc display_0_DSP_R 1 2 4 N 470 NJ 470 NJ 470 1800J
preplace netloc util_reduced_logic_0_Res 1 6 1 NJ
preplace netloc dispsub_0_DCLK 1 1 6 410 360 NJ 360 NJ 360 NJ 360 NJ 360 2090
preplace netloc axi_iic_0_IIC 1 6 1 NJ
preplace netloc regbus_0_WDATA 1 1 6 350 310 NJ 310 NJ 310 NJ 310 NJ 310 2090
preplace netloc axi_iic_0_gpo 1 5 2 1800 630 2070
preplace netloc display_0_M_AXI 1 2 1 720
preplace netloc display_0_DSP_G 1 2 4 N 490 NJ 490 NJ 490 1780J
preplace netloc regbus_0_BYTEEN 1 1 6 380 10 NJ 10 NJ 10 NJ 10 NJ 10 2070
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 10 240 340 240 730 240 1000 240 1470 240 1790
preplace netloc display_0_DSP_VSYNC_X 1 2 4 680 880 NJ 880 NJ 880 1780J
preplace netloc display_0_DSP_HSYNC_X 1 2 4 700 540 NJ 540 NJ 540 1730J
preplace netloc processing_system7_0_FCLK_CLK1 1 4 2 1430J 440 N
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 5 1 1730
levelinfo -pg 1 -10 170 540 860 1200 1600 1940 2140 -top 0 -bot 1130
",
}
