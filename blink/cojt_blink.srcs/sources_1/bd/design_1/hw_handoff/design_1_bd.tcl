...
proc create_root_design { parentCell } {
  ...
  # Create instance: myport_v1_0_0, and set properties
  set myport_v1_0_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:myport_v1_0:1.0 myport_v1_0_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /myport_v1_0_0/s00_axi]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins myport_v1_0_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net myport_v1_0_0_LED [get_bd_ports LED] [get_bd_pins myport_v1_0_0/LED]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins myport_v1_0_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins myport_v1_0_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myport_v1_0_0/s00_axi/reg0] SEG_myport_v1_0_0_reg0
...
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 830 -defaultsOSRD
preplace inst myport_v1_0_0 -pg 1 -lvl 1 -y 60 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 1 -y 610 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 360 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 1 410
preplace netloc processing_system7_0_M_AXI_GP0 1 0 2 10 230 370
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 10 920 390
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 0 2 10 730 370
preplace netloc processing_system7_0_FIXED_IO 1 1 1 420
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 2 0 490 380
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 -20 220 380
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 2 -10 130 400
preplace netloc myport_v1_0_0_LED 1 1 1 N
levelinfo -pg 1 -40 190 440 -top 0 -bot 930
",
}
