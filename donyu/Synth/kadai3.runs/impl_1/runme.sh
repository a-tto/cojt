...
HD_PWD='C:/cojt/donyu/Synth/kadai3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kadai3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kadai3.tcl -notrace
