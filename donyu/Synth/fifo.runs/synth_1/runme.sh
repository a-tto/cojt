...
HD_PWD='C:/cojt/donyu/Synth/fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_yatteiki.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_yatteiki.tcl
