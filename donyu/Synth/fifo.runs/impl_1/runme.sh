...
HD_PWD='C:/cojt/donyu/Synth/fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_yatteiki.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_yatteiki.tcl -notrace
